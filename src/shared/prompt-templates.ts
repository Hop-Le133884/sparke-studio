...
// original to Sparke; they do not bundle third-party prompt catalogs verbatim.
...
export const promptTemplates: PromptTemplate[] = [
  {
    ...
    aspectRatio: '3:4', provider: 'openai', model: 'gpt-image-1', attribution: 'Original seed prompt for Sparke.',
  },
  {
    ...
    aspectRatio: '16:9', provider: 'gemini', model: 'gemini-3.1-flash-image', attribution: 'Original seed prompt for Sparke.',
  },
  {
    ...
    aspectRatio: '1:1', provider: 'fal', model: 'fal-ai/flux/dev', attribution: 'Original seed prompt for Sparke.',
  },
  {
    ...
    aspectRatio: '4:3', provider: 'fal', model: 'fal-ai/flux/dev', attribution: 'Original seed prompt for Sparke.',
  },
  {
    ...
    aspectRatio: '16:9', provider: 'fal', model: 'fal-ai/kling-video/v2.5-turbo/pro/text-to-video', attribution: 'Original seed prompt for Sparke.',
  },
  {
