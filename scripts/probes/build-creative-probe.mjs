...
await writeFile(target, `<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Sparke — Drawing lab</title><!--\n${notices.join('\n\n').replace(/-->/g, '-- >')}\n--><main id="probe"></main><script>${script}</script></html>`);
console.log(target);
